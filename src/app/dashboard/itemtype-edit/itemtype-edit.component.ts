...
@Component({
    moduleId: module.id,
    selector: 'itemtype-edit',
    templateUrl: 'itemtype-edit.component.html',
    styleUrls: ['itemtype-edit.component.scss']
})
export class ItemtypeEditComponent implements OnInit {
   ...
   constructor(private pageTitleService: Title, 
    ...
    loadItem(){
        ...
        this.call.postRequest("/ItemType/ItemForEdit/"+this.id,"",
        next=>{
